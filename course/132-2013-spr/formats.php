...
function format_argument_as_HTML($t) {
  ...
  $t=str_replace('<comment>', '<span style="margin-left:25px; color:green; font-style:italic;"># ', $t);
  $t=str_replace('</comment>', '</span>', $t);
...
function format_custom_as_HTML($t) {
  ...
  $t=tr($t, '\\leftarrow', '<span style="font-size:12px;">&#8592;</span>');
  $t=tr($t, '\\downarrow', '<span style="font-size:12px;">&#8595;</span>');
  $t=tr($t, '\\uparrow', '<span style="font-size:12px;">&#8593;</span>');
  ...
  $t=tr($t, '_{50}', '<sub>50</sub>');
  $t=tr($t, '_{51}', '<sub>51</sub>');
  $t=tr($t, '_{100}', '<sub>100</sub>');
