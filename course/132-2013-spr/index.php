...
$schedule = array(
  ...
  array(
    ...
    'details' => array(
      ...
      'related readings:<ul><li>[Lay 2012]: 6.1</li><li>[Bretscher 2009]: 1.3.6; 5.1; A.4</li></ul>'
      )
  ),
  array(
    'date' => '2013-01-24',
  ...
  array(
    ...
    'topics' => 'matrices',
    'details' => array(
      '<a href="s.html#lecture7a">lecture notes</a>',
  ...
  array(
    ...
    'topics' => 'matrices',
    'details' => array(
      '<a href="s.html#lecture7b">lecture notes</a>',
      'invertible matrices',
  ...
  array(
    ...
    'topics' => 'matrices',
    'details' => array(
      '<a href="s.html#lecture8a">lecture notes</a>',
      ...
      '<i>Mv</i> = <i>w</i> for <i>M</i> with various properties<ul><li><i>M = LU</i></li></ul>',
  ...
  array(
    ...
    'topics' => 'matrices',
    'details' => array(
      '<a href="s.html#lecture10a">lecture notes</a>',
  ...
  array(
    'date' => '2013-03-05',
    'dateHTML' => '<span style="text-decoration:underline;">2013-03-05</span><br/><span  style="font-size:10px;">Tuesday<br/>11-12:30 PM</span>',
    'type' => 'midterm exam',
    'cls' => 'midterm',
    'topics' => '',
    'details' => array(),
  ...
  array(
    ...
    'details' => array(
      ...
      'related readings:<ul><li>[Lay 2012]: 1.7</li><li>[Bretscher 2009]: 4.1</li></ul>'
      ),
  ),
  array(
    'date' => '2013-03-26',
    ...
    'topics' => 'vector spaces',
    'details' => array(
      '<a href="s.html#lecture14b">lecture notes</a>',
  ...
  array(
    ...
    'details' => array(
      '<a href="s.html#lecture18a">lecture notes</a>',
  ...
  array(
    ...
    'details' => array(
      ...
      'related readings:<ul><li>[Lay 2012]: 1.9</li><li>[Bretscher 2009]: 3.1; 3.2; 4.2</li></ul>'
      ),
  ),
  array(
    'date' => '2013-04-16',
    ...
    'details' => array(
      ...
      'related readings:<ul><li>[Lay 2012]: 1.9; 2.9.1; 4.4.5</li><li>[Bretscher 2009]: 4.2; 5.4</li></ul>'
      ),
  ),
  array(
    'date' => '2013-04-18',
    'dateHTML' => '<span style="text-decoration:underline;">2013-04-18</span><br/><span  style="font-size:10px;">Monday sched.<br/>(section)</span>',
    'type' => 'practice<br/>quiz',
    'cls' => 'midterm',
    'topics' => '',
    'details' => array(
      '<a href="quiz.pdf">quiz (with solutions)</a>',
    ),
  ),
  array(
    'date' => '2013-04-23',
  ...
  array(
    ...
    'details' => array(
      '<a href="s.html#lecture22a">lecture notes</a>',
  ...
  array(
    ...
    'cls' => 'assignmentdate',
    'topics' => '',
    'details' => array('<b><a href="s.html#assignment5">assignment #5</a> - last day to submit</b><br/>(late penalty waived)'),
  ),
  array(
    'date' => '2013-04-30',
    'type' => 'lecture',
  ...
  array(
    'date' => '<span style="text-decoration:underline;">2013-05-08</span><br/><span  style="font-size:10px;">Wednesday<br/>12:30-2:30 PM<br/><a href="http://www.bu.edu/maps/?id=751">KCB</a> 106</span>',
    'type' => 'final exam',
    'cls' => 'final',
    'topics' => '',
    'details' => array(),
...
<html>
 <head>
 <title>BU CAS CS 132 Spring 2013</title>
 <style>
 ...
 <div id="container">
  ...
  <div id="info">
   <br/><b>Computer Science 132 - Geometric Algorithms</b>
   <br/>
   <br/>
   <br/>
   <ul class="info_items">
    <li><span class="sect">lectures:</span>
     <br/>&nbsp;&nbsp; Tue. & Thu., 11:00 AM - 12:30 PM in GCB 205
    ...
    <li><span class="sect">sections:</span>
     ...
     <br/>&nbsp;&nbsp; <span class="lbl">teaching fellow:</span> Ang Liu (<a href="mailto:aliu12@bu.edu">aliu12@bu.edu</a>)
     <br/>&nbsp;&nbsp; <span class="lbl">OH:</span> Mon. 5-6 PM; Tue. 3:30-5:30 PM (undergrad. CS lab)
     <br/>
     <br/>
    </li>
    <li><span class="sect">for questions and discussion:</span>
     <br/>&nbsp;&nbsp; <a href="mailto:cascs132a1-l@bu.edu">cascs132a1-l@bu.edu</a> (course mailing list)
     <br/>&nbsp;&nbsp; <a href="https://piazza.com/bu/spring2013/cs132">Q&amp;A page</a> on Piazza
    </li>
   </ul>
   <br/>
   <ul class="info_items">
   ...
   <ul class="info_items">
    <li><span class="sect">course materials:</span>
     ...
     <br/>&nbsp;&nbsp; <b><a href="s.html#assignment6">bonus problems</a></b>
     <br/>&nbsp;&nbsp; <b><a href="quiz.pdf">quiz (with solutions)</a></b>
    </li>
   </ul>
   <br/>
   <!--<ul class="info_items">
