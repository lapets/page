...
\end{eqnarray}
  ...
  $solution =
      '<solution hooks="math"><![CDATA[
Using <a href="m.php?#e7d7dd05b62144f1a68b78d34d9e268a">Fermat\'s little theorem</a>, the solution is:
\begin{eqnarray}
...
Compute the result of \phi('.$n.').
  ...
  $solution = '
        <solution hooks="math"><![CDATA[
By applying a combination of the facts about computing the <a href="m.php#363015589b5c4b168afdf08dc2b2e609">Euler totient function</a> \varphi for
<a href="m.php#3124a3c8c9744310bbe184f41be5e8d2">prime numbers</a>,
<a href="m.php#15f709b061db4798ab0ff29bef64f200">powers of primes</a>, and 
<a href="m.php#da48e3ec693c4a07b4c6da648e5c1996">products of coprime numbers</a>, 
...
\end{eqnarray}
  ...
  if ($g == 1) {
    $solution = '
        <solution hooks="math"><![CDATA[
Using the explicit <a href="m.php#cdf66ebaf3a24a54a2b097be73f8a8f4">formula</a> for a Chinese remainder theorem solution for a system of two equations when the moduli are coprime, we find that the unique congruence class of solutions is:
\begin{eqnarray}
...
\end{eqnarray}
    ...
    $solution = '
        <solution hooks="math"><![CDATA[
Using the <a href="m.php#9713fd6d470a483cae1159e87897512b">process</a> for computing a Chinese remainder theorem solution for a system of two equations when the moduli are not necessarily coprime, we find that the unique congruence class of solutions is:
\begin{eqnarray}
...
\end{eqnarray}
  ...
  $solution = $solution != null ?
      '<solution hooks="math"><![CDATA[
Using the <a href="m.php#3d06a3b21e4846728ea3569d9d1d7c6f">explicit formula</a> for computing square roots of congruence classes modulo a prime, the solution is:
\begin{eqnarray}
...
\end{eqnarray}
    ...
    :
      '<solution hooks="math"><![CDATA[
We attempt to use the <a href="m.php#3d06a3b21e4846728ea3569d9d1d7c6f">explicit formula</a> for computing roots of congruence classes modulo a prime:
\begin{eqnarray}
  %x & \equiv & \pm ('.$r.')<sup>('.$p.'+1)/4</sup> (\mod '.$p.') %%
...
function wrapXML($link, $exercise_solution) {
  return
      '<material title="BU CAS CS 235 Spring 2014">'
