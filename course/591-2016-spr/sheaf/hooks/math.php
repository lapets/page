...
function sheaf_hook_math ($s) {
  ...
  $s=sheaf::r($s, '#[', '</td><td><table cellpadding="0" cellspacing="0" style="display:inline;"><tr><td class="html_matrix_lft">&nbsp;</td><td><table cellpadding="0" cellspacing="0" style="font-size:12px;"><tr><td style="white-space:nowrap;">');
  $s=sheaf::r($s, '#;', '</td></tr><tr><td style="white-space:nowrap;">');
  $s=sheaf::r($s, '#,', '</td><td style="padding-left:8px; white-space:nowrap;">');
  $s=sheaf::r($s, '#]', '</td></tr></table></td><td class="html_matrix_rgt">&nbsp;</td></tr></table></td><td>');
